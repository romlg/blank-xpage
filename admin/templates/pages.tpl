...
<table width='100%' border='0' cellspacing='0' cellpadding='2' bgcolor='#F5F5F5' class='w_border'>
    <tr>
        ...
        <td class='w_border' align='center'>{HEAD_SEC}</td>
        <td class='w_border' width='120' colspan='6' align='center'>Действия</td>
    </tr>
    <!-- BEGIN: TABLE_ROW -->
    ...
    <!-- BEGIN: TABLE_EMPTY -->
    <tr bgcolor='{ROW_BGCOLOR}'>
        <td class='w_border' colspan='10' align='center'>Список пуст</td>
    </tr>
    <!-- END: TABLE_EMPTY -->
